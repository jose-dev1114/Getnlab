      ...
      <section className="download-hero-section">
        ...
        <div className="download-hero-content">
          <div className="download-hero-text">
            ...
            <button className="download-cta-button">
          ...
          <div className="download-app-section">
            ...
            <div className="download-tab-content">
              <div className="tab-panel active" id="mac-panel">
                ...
                <button className="download-platform-button">
              ...
              <div className="tab-panel" id="nlab-api-panel">
                <p className="tab-description">
                  Access the nLab API to integrate with your own applications
                  and build custom solutions with your Starter Kit.
                </p>
                <button className="download-platform-button">
                  Access nLab API <img src="/svg/api.svg" alt="API" className="platform-icon" />
                </button>
              </div>
            </div>
          </div>
